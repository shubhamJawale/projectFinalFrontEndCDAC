...
export default function UpdateCLabour() {
    ...
    let getuser = () => {
        ...
        let userId = JSON.parse(sessionStorage.getItem("tempuid"));
    ...
    return (
        <div className="container">
            ...
            <div className="col-12 offset-1 justify-content-center container my-5">
